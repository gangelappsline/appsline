...
const AboutUs = () => {
  ...
  return <Layout title={t("about.pageTitle")}><div className="bg-[#080a0f] text-white">
    <section className="relative overflow-hidden border-b border-white/10 px-5 py-24 lg:py-36"><div className="absolute right-[-10%] top-[-40%] h-[600px] w-[600px] rounded-full bg-[#0060FC]/10 blur-3xl"/><div className="relative mx-auto max-w-7xl"><p className="section-kicker">{t("about.eyebrow")}</p><h1 className="max-w-5xl text-5xl font-semibold leading-[1.05] tracking-[-.05em] sm:text-7xl">{t("about.heroTitle")} <span className="text-[#00A3FE]">{t("about.heroAccent")}</span></h1><p className="mt-8 max-w-2xl text-xl leading-8 text-slate-400">{t("about.heroText")}</p></div></section>
